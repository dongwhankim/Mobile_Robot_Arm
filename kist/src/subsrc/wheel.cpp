...
void Cwheel::Open_port()
{
  ...
  _port = open("/dev/ttyUSB2", O_RDWR|O_NOCTTY);
...
unsigned char Cwheel::GetCheckSum(char nPacketSize, unsigned char *byArray)
{
    char byTmp=0;
    char i;
    for(i=0; i<nPacketSize; i++) 
